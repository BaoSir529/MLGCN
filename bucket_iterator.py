...
class BucketIterator(object):
    ...
    def pad_data(self, batch_data):
        ...
        for item in batch_data:
            text_indices, context_indices, aspect_indices, pos_indices, left_indices, polarity, dependency_graph, word_height = \
                item['text_indices'], item['context_indices'], item['aspect_indices'], item['pos_indices'], item['left_indices'], \
