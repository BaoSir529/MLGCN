...
class Instructor:
    def __init__(self, opt):
        ...
        self.train_data_loader = BucketIterator(data=absa_dataset.train_data, batch_size=opt.batch_size, shuffle=True, sort=True)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--rnn_drop', default=0.1, type=float, help='RNN dropout rate.')
    parser.add_argument('--gcn_drop', default=0.1, type=float, help='GCN dropout rate.')
